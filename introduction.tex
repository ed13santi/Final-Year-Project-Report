...
introduces the state-decomposition method more specifically, explaining the high-level ideas and the originally devised method to
decompose state-spaces. Chapter-4 presents the tools and methods that were used in testing the state-decomposition technique and
...
technique could be useful. Lastly, Chapter-7 discusses the findings of this project, its limitation and possible extension and
future work.
