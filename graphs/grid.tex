\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{'Grid' environment. The dotted lines have no effect on the environment, they are just used to separate what will be referred to as the uppper-left triangle and the lower-right triangle.}
    \label{fig:grid}
\end{figure}