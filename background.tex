...
Artificial neural networks are a type a function approximators that have been very popular in the last years thanks to improvements in computational power which made them a favourite choice in many data-driven applications, such as pattern recognition, computer vision, etc... in which they achieve state-of-the-art performance. They are especially useful as they are able to 'learn' the underlying structure of very large dimensional data when fed enough training samples.

\paragraph{}
The building block of artificial neural networks is the \italic{perceptron}. 
