...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Taxi2_DQN_and_DeltaSwitch.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/DeltaSwitch_oneHot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/GridEps2DeltaSwitch.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/encodings_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/size_comparison_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/GridNoWall_dqn_DeltaSwitch_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/GridNoWall_dqn_DeltaSwitch_compare_delta_samples.pdf}
...
\begin{figure}
    \hspace{-1cm}
    \begin{tabular}{cc}
      \includegraphics[width=0.6\linewidth]{figures/geps2_0_samples.pdf} & \includegraphics[width=0.6\linewidth]{figures/geps2_001_samples.pdf} \\
      (a) $\delta=0\%$ & (b) $\delta=1\%$ \\
      \includegraphics[width=0.6\linewidth]{figures/geps2_002_samples.pdf} & \includegraphics[width=0.6\linewidth]{figures/geps2_003_samples.pdf} \\
      (c) $\delta=2\%$ & (d) $\delta=3\%$ \\
      \includegraphics[width=0.6\linewidth]{figures/geps2_004_samples.pdf} & \includegraphics[width=0.6\linewidth]{figures/geps2_005_samples.pdf} \\
      (e) $\delta=4\%$ & (f) $\delta=5\%$ \\
    \end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/effectReduced_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Wall-DQN-deltaSwitch_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/learnSwitch1_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/initialisedLearnSwitch_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/Sarsa_samples.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/simultaneous_samples.pdf}
