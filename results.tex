...
\begin{figure}
    \centering
    \begin{tabular}{cc}
      \includegraphics[width=0.45\linewidth]{figures/geps2_0.png} & \includegraphics[width=0.45\linewidth]{figures/geps2_001.png} \\
      (a) $\delta=0\%$ & (b) $\delta=1\%$ \\
      \includegraphics[width=0.45\linewidth]{figures/geps2_002.png} & \includegraphics[width=0.45\linewidth]{figures/geps2_003.png} \\
      (c) $\delta=2\%$ & (d) $\delta=3\%$ \\
      \includegraphics[width=0.45\linewidth]{figures/geps2_004.png} & \includegraphics[width=0.45\linewidth]{figures/geps2_005.png} \\
      (e) $\delta=4\%$ & (f) $\delta=5\%$ \\
    \end{tabular}
