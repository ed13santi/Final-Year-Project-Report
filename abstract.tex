...
This report focuses on grouping the states into sub-spaces which have low probability of transitions between each other. The
...
on techniques to share common information between similar sub-spaces.
