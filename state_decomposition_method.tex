...
\subsection[Decomposing state trans. matrix]{Decomposing the state transition matrix}
...
ONE OR TWO EXAMPLES TO DEMONSTRATE HOW THE STATE DECOMPOSITION WORKS

ALSO MENTION HOW YOU CAN DECOMPOSE USING TRANSITION TABLES AT DIFFERENT STAGES. FOR EXAMPLE, DECOMPOSING BY DESTINATION IS LIKE
DECOMPOSING USING A RANDOM POLICY, WHILE DECOMPOSIIGN BY POSITION IS LIKE DECOMPOSITION USING THE OPTIMAL POLICY


EXPLANATION OF HAVING BASICALLY DIFFERNT PARTS OF THE BRAIN DOING DIFFERENT THINGS